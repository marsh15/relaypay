...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/admin/v1/environments/{environment_id}/dispute-packages/{package_id}/download".format(environment_id=quote(str(environment_id), safe=""),package_id=quote(str(package_id), safe=""),),
        "cookies": cookies,
    }
