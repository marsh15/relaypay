...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/admin/v1/environments/{environment_id}/merchant-accounts/{merchant_account_id}/settlements".format(environment_id=quote(str(environment_id), safe=""),merchant_account_id=quote(str(merchant_account_id), safe=""),),
        "cookies": cookies,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Post Merchant Account Settlement
