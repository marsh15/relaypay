...
from ...models.connector_verify import ConnectorVerify
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/admin/v1/environments/{environment_id}/connector-versions/{version_id}/verify".format(environment_id=quote(str(environment_id), safe=""),version_id=quote(str(version_id), safe=""),),
        "cookies": cookies,
    }
