"""Prove v0.13 upgrades to v0.14 without rewriting authoritative rows."""
    ...
    try:
        with engine.begin() as connection:
            return {
                ...
                if table not in SETTLEMENT_TABLES | {"alembic_version"}
            }
    finally:
        engine.dispose()
...
def main() -> None:
    schema = f"m13_upgrade_{uuid.uuid4().hex}"
    ...
    print("M13 upgrade proof passed: v0.13 evidence preserved; v0.14 settlement starts empty")
